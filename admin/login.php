...
if (isset($_POST['submit'])) {
     ...
     */
    $query = "SELECT id, username, email, fullname, gender, phone, birthday FROM accounts WHERE (username = '{$username}' OR email = '{$username}') AND password = '{$password}' AND status = 'ACTIVE' AND role = 'admin' OR role = 'manage'";
